...
<?php
	...
	if(isset($_GET["library_id"]) && !empty(trim($_GET["library_id"]))){
		$_SESSION["library_id"] = $_GET["library_id"];
	}
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		if(isset($_SESSION["library_id"]) && !empty($_SESSION["library_id"])){ 
			...
			// Bind variables to the prepared statement as parameters
				mysqli_stmt_bind_param($stmt, "s", $param_library_id);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            <input type="hidden" name="library_id" value="<?php echo ($_SESSION["library_id"]); ?>"/>
                            <p>Are you sure you want to delete the record for <?php echo ($_SESSION["library_id"]); ?>?</p><br>
